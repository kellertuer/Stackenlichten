...
%\definecolor{hl}{HTML}{777777} % left reddish
%\definecolor{hl2}{HTML}{777777} % right yellowish
%\definecolor{hl3}{HTML}{777777} % top blueish
...
%   (C14)
    ...
    \draw[bg] ($(A1)+(210:.05pt)$) -- ($(A14)+(330:.05pt)$) -- ($(B14)+(90:.05pt)$) -- cycle;
    \draw[fill=bg,draw=none] (A2) -- (A3) -- (A4) -- (A5);
    \draw[fill=bg,draw=none] (A6) -- (A7) -- (A8) -- (A9);
    \draw[fill=bg,draw=none] (A10) -- (A11) -- (A12) -- (A13);
    \draw[fill=bg,draw=none] (B2) -- (B3) -- (B4) -- (B5);
    \draw[fill=bg,draw=none] (B6) -- (B7) -- (B8) -- (B9);
    \draw[fill=bg,draw=none] (B10) -- (B11) -- (B12) -- (B13);
    \draw[fill=bg,draw=none] (C2) -- (C3) -- (C4) -- (C5);
    \draw[fill=bg,draw=none] (C6) -- (C7) -- (C8) -- (C9);
    \draw[fill=bg,draw=none] (C10) -- (C11) -- (C12) -- (C13);
    %
